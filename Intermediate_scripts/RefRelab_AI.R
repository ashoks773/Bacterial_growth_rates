########################################################################
#5--Activity Index on Relative Abundances Calculated on Referene Genomes
########################################################################
...
library(vegan)
Ref_Relab_D <- as.matrix(vegdist(Ref_Relab_meta[,1:188], method="bray"))
...
# Threshold activity
Ref_Relab_disease_activity_threshold <- quantile(Ref_Relab_meta$activity_index[Ref_Relab_meta$diagnosis=="nonIBD"], 0.9)
Ref_Relab_eubiosis_lower_threshold <- quantile(Ref_Relab_meta$activity_index[Ref_Relab_meta$diagnosis=="nonIBD"], 0.1)
Ref_Relab_meta$active <- Ref_Relab_meta$activity_index >= Ref_Relab_disease_activity_threshold
