...
range_d <- range (list(C3001_diseaseAI[,1:5]))
...
plot(C3001_diseaseAI$visit_num, C3001_diseaseAI$metaphln, type = "b", frame = FALSE, pch = 19, 
     col = "red", xlab = "visits", ylab = "Dysbiosis Score", ylim = c(0.45, range_d[2]+0.1)) 
lines(C3001_diseaseAI$visit_num, C3001_diseaseAI$binsPTR, pch = 19, col = "blue", type = "b", lty = 1)
lines(C3001_diseaseAI$visit_num, C3001_diseaseAI$binsRelab, pch = 19, col = "orange", type = "b", lty = 1)
lines(C3001_diseaseAI$visit_num, C3001_diseaseAI$Ref_PTR, pch = 19, col = "darkred", type = "b", lty = 1)
lines(C3001_diseaseAI$visit_num, C3001_diseaseAI$Ref_Relab, pch = 19, col = "cyan", type = "b", lty = 1)
